...
export const Profile = ({ memberId, onClose }: ProfileProps) => {
    ...
    if (isLoadingMember || isLoadingCurrentMember) {
        return (
            <div className="h-full flex flex-col">
                <div className="flex justify-between items-center h-12.25 px-4 border-b">
    ...
    return (
        <>
            ...
            <RemoveDialog />
            <div className="h-full flex flex-col">
                <div className="bg-[#92ac93] flex justify-between items-center h-12.25 px-4 border-b">
                    <p className="text-lg font-bold">Profile</p>
                    <Button onClick={onClose} variant="ghost" size="iconSm">
                        <XIcon className="size-5 stroke-[1.5]" />
                    </Button>
                ...
                <div className="flex flex-col items-center justify-center p-4">
                    <Avatar className="max-w-[256px] max-h-64 size-full">
                    ...
                    {currentMember?.role === "admin" &&
                        ...
                        <div className="flex items-center gap-2 mt-4">
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button variant="outline" className="flex-1 capitalize">
                                        {member.role}
                                        <ChevronDownIcon className="size-4 ml-2 text-muted-foreground" />
                                    </Button>
                                </DropdownMenuTrigger>
                            ...
                            <Button
                                onClick={onRemove}
                                variant="outline"
                                className="flex-1 text-rose-600 border-rose-200 hover:bg-rose-50 hover:text-rose-700 hover:border-rose-300"
                            >
                                Remove
                            </Button>
                        </div>
